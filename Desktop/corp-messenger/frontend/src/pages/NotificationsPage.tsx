...
// Схема БД: id, user_id, type, title, message, related_id, is_read, created_at
...
const NotificationsPage: React.FC = () => {
  ...
  useEffect(() => {
    socketService.onNotification((n: Notification) => {
  ...
  const handleClick = (n: Notification) => {
    ...
    if (n.related_id && (n.type === 'message' || n.type === 'mention')) navigate('/chat');
  };
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button onClick={fetchNotifications} style={btnStyle('#6c757d')}>↻ Обновить</button>
          </div>
        </div>
        ...
        {!loading && error && (
          <div style={emptyBox}>
            ...
            <button onClick={fetchNotifications} style={btnStyle('#667eea')}>Повторить</button>
          </div>
        )}
